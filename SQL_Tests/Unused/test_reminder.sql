...
INSERT IGNORE INTO Reminder (reminder_id, event_id, message, send_date, was_sent, was_read) 
VALUES (999, 999, 'Test reminder - Oil change due today!', CURDATE(), 0, 0);

-- Add another reminder for tomorrow
INSERT IGNORE INTO Reminder (reminder_id, event_id, message, send_date, was_sent, was_read) 
VALUES (998, 999, 'Test reminder - Brake inspection tomorrow', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 0, 0); 